...
*/
function instagram($token = '286515358.9b6b2bd.a762ed334144471b82b497bba1084499', $count = 10, $cache = true, $cache_expire = 3600, $user = 'self') {
...
class instagram {
     ...
     */
    function __construct($_token = '286515358.9b6b2bd.a762ed334144471b82b497bba1084499', $_count = 10, $_cache = true, $_cache_expire = 3600, $_user = 'self') {
        // Init
        $this->images   = array();
